...
export type OpenEvaluationDisputeRequestInput = NonNullable<operations["openEvaluationDispute"]["requestBody"]>["content"]["application/json"];
...
export type OpenEvaluationDisputeResponse = operations["openEvaluationDispute"]["responses"]["201"]["content"]["application/json"];
