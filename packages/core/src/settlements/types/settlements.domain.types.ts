...
export type SettlementRequest = components["schemas"]["SettlementRequest"];
...
export type SettleContestRequestInput = NonNullable<operations["settleContest"]["requestBody"]>["content"]["application/json"];
...
export type SettleContestParams = operations["settleContest"]["parameters"]["path"];
...
export type SettleContestResponse = operations["settleContest"]["responses"]["202"]["content"]["application/json"];
