/**
 * Deploygates API Types
 *
 * API contract types come from @modelescrow/core.
 * This file contains ONLY re-exports - no local API contract definitions.
 */

// ============================================================================
// API Type Re-exports (from @modelescrow/core)
// ============================================================================
...
export type {
  // Add types from @modelescrow/core/deploygates
} from "@modelescrow/core";

// Re-export with alias for backward compatibility if needed
// export type CoreDeploygatesItem = DeploygatesItem;
