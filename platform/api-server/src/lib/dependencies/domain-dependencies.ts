...
const DOMAIN_PATH_PATTERNS: Array<{ pattern: RegExp; domain: string }> = [
  ...
  { pattern: /\/contests\//, domain: "contests" },
  { pattern: /\/deploygates\//, domain: "deploygates" },
  { pattern: /\/disputes\//, domain: "disputes" },
  { pattern: /\/escrows\//, domain: "escrows" },
...
export async function injectDomainDependencies(
  ...
  if (!domainDeps) {
    ...
    switch (domain) {
      case "contests":
        domainDeps = buildContestsDomainModule(dynamoClient);
        break;
      case "deploygates":
        domainDeps = buildDeploygatesDomainModule(dynamoClient);
        break;
      case "disputes":
        domainDeps = buildDisputesDomainModule(dynamoClient);
        break;
      case "escrows":
        domainDeps = buildEscrowsDomainModule(dynamoClient);
        break;
      case "evaluations":
...
export interface DomainDependencies {
  contests: ContestsDomainModule;
  deploygates: DeploygatesDomainModule;
  disputes: DisputesDomainModule;
  escrows: EscrowsDomainModule;
 ...
 */
export function getContestsDeps(
  request: FastifyRequest,
): DomainDependencies["contests"] {
  return getDomainDeps(request, "contests");
}
export function getDeploygatesDeps(
  request: FastifyRequest,
): DomainDependencies["deploygates"] {
  return getDomainDeps(request, "deploygates");
}
...
export function getEscrowsDeps(
  request: FastifyRequest,
): DomainDependencies["escrows"] {
  return getDomainDeps(request, "escrows");
}
