/**
 * Submissions Services - Application Layer Export
 *
...
/**
 * Submissions Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for submissions domain.
 */
