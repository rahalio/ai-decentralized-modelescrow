 ...
 *
 * @returns The core table name (e.g., "modelescrow-core-dev")
 ...
 *
 * @returns The base table name (e.g., "modelescrow-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "modelescrow-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "modelescrow-app-realtime-dev")
